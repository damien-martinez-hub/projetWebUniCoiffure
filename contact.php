        ...
        <div class="col-12 col-xl-11">
          <div class="mb-4 mb-md-5">
            ...
            <div>
              ...
              <address class="m-0 text-secondary">49 rue Monthyon, 97400 Saint Denis</address>
            </div>
          </div>
            ...
            <div class="col-12 col-sm-6">
              <div class="mb-4 mb-sm-0">
                ...
                <div>
                  ...
                  <p class="mb-0">
                    <a class="link-secondary text-decoration-none" href="tel:+15057922430">+262 693 60 68 47</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="mb-4 mb-sm-0">
                ...
                <div>
                  ...
                  <hr class="w-75 mb-3 border-dark-subtle">
                  <p class="mb-0">
                    <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">elizecoif@gmail.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div>
              ...
              <hr class="w-50 mb-3 border-dark-subtle">
              <div class="d-flex justify-content-center" mb-1 me-auto">
                <p class="text-secondary fw-bold mb-0 me-5">Mardi - Jeudi</p>
                <p class="text-secondary mb-0">09h00 - 12h00 / 13h00 - 18h00</p>
              </div>
              <div class="d-flex justify-content-center">
                <p class="text-secondary fw-bold mb-0 me-5">Vendredi - Samedi</p>
                <p class="text-secondary mb-0">09h00 - 12h00 / 13h00 - 18h30</p>
              </div>
            </div>
          </div>
        </div>
