        ...
        <form method="post">
            ...
            <div class="c100" >
             ...
             <ul style="list-style-type: square;">
                <li style="border:none;">Au moins une lettre majuscule.</li>
                <li style="border:none;">Au moins une lettre minuscule.</li>
                <li style="border:none;">Au moins un chiffre.</li>
                <li style="border:none;">Au moins 8 caractères</li>
              </ul>
            </div>
          ...
          <?php include 'server/inscription_server.php'; ?>  
